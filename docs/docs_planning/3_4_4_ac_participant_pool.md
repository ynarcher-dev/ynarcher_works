...
* NETWORKS 스타트업/전문가 마스터와 참가자 풀의 데이터 매핑 관계
...
├────────────────────────────────────────────────────────────────────────┤
│ [검색: 이름/기업명]  [+ CSV 일괄 업로드]  [+ NETWORKS 마스터에서 추가] │
├────────────────────────────────────────────────────────────────────────┤
│ 이름/기업명 | 원본 마스터      | 부여된 프로그램 역할 | 활성 모듈 범위   | │
│ ────────────────────────────────────────────────────────────────────── │
│ 홍길동      | NETWORKS 전문가  | MENTOR, REVIEWER     | 멘토링, 서면평가 | │
│ 스타트업A   | NETWORKS 스타트업| STARTUP              | 모집, 멘토링, 매칭| │
│ 이순신      | 임직원(MGMT)     | PROGRAM_OPERATOR     | 전 모듈          | │
│ ────────────────────────────────────────────────────────────────────── │
...
* **CSV 일괄 업로드**: 다수의 전문가 및 스타트업을 CSV 파일로 일괄 업로드하여 풀에 적재할 수 있습니다. 이때 등록된 이메일과 전화번호를 기준으로 `NETWORKS 마스터`를 자동 검색하여 매핑 관계를 수립합니다.
...
CREATE TABLE program_participants (
    ...
    master_id UUID,                              -- NETWORKS 스타트업 마스터 또는 전문가 마스터의 ID 연동
