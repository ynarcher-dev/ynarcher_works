...
| **[3-4-4]** | [3_4_4_ac_participant_pool.md](./3_4_4_ac_participant_pool.md) | **연동 DB(참가자 명부) 및 게스트 로그인 개방**: 계정 역할과 사업 참여 역할 분리, NETWORKS 원장 수동 매핑, 사업 고정코드 기반 게스트 로그인 허용·차단 |
