import { Button, Spinner, TextArea } from '@ynarcher/ui'
...
/**
 * 피드백 패널(공용). 게시판 댓글과 유사한 레코드 단위 코멘트 스레드.
...
export function FeedbackPanel({
  ...
  return (
    <DetailPanelCard title="피드백" count={list.length}>
      ...
      <div className="mt-3">
        {isLoading ? (
          ...
          <p className="text-body text-gray-400">등록된 피드백이 없습니다.</p>
        )}
      </div>
    </DetailPanelCard>
  )
