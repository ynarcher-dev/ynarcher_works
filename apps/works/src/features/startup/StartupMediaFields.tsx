        ...
        <div key={i} className="space-y-2 rounded-radius-md border border-gray-200 p-3">
          ...
          <div className="flex flex-wrap items-end gap-2">
            <label className="min-w-56 flex-1 block">
              <span className="mb-0.5 block text-caption text-gray-500">URL</span>
              <Input
                placeholder="https://…"
                value={m.url ?? ''}
          ...
          <div className="flex flex-wrap items-end gap-2">
            <label className="w-40 block">
              <span className="mb-0.5 block text-caption text-gray-500">분류</span>
            ...
            <label className="min-w-56 flex-1 block">
              <span className="mb-0.5 block text-caption text-gray-500">제목</span>
          ...
          <label className="block">
            <span className="mb-0.5 block text-caption text-gray-500">설명</span>
            <TextArea
              rows={2}
              value={m.description ?? ''}
          ...
          {m.image && (
            <div className="flex items-center gap-2">
              ...
              <span className="truncate text-caption text-gray-400">{m.siteName}</span>
            </div>
          )}
        </div>
      ))}
