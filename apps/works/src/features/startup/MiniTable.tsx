...
export const th = 'h-9 border-b border-gray-200 px-3 text-right text-caption font-semibold text-gray-700'
export const thL = 'h-9 border-b border-gray-200 px-3 text-left text-caption font-semibold text-gray-700'
