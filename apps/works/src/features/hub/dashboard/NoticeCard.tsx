            ...
            {notices.slice(0, VISIBLE_NOTICES).map((notice) => (
              <li key={`${notice.boardSlug}:${notice.post.id}`}>
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-radius-md border border-gray-200 bg-white px-3 py-2 text-left transition-colors duration-fast hover:border-gray-300 hover:bg-gray-25 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand/10"
                >
