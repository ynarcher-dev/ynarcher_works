...
export const MODULE_META: Record<string, ModuleMeta> = {
  ...
  POST: {
    ...
    detail:
      '회의록·활동 기록·공지 등 프로젝트 운영 중 남길 글을 게시판처럼 관리합니다. 리치텍스트 에디터로 작성하고, 목록에서 골라 읽거나 언제든 수정할 수 있습니다. 무엇을 넣을지 정하지 못했다면 이 템플릿으로 시작하세요.',
    tab: 'post',
  },
  LINK: {
    icon: LinkIcon,
    ...
    detail:
      '설문 폼·외부 자료·협업 문서 등 프로젝트와 관련된 주소를 여러 개 모아 둡니다. 각 링크에 설명을 달아 두면, 모듈을 누를 때 어디로 갈지 고르는 버튼 목록이 바로 열립니다.',
    tab: 'link',
  },
  FILE: {
    icon: Paperclip,
    ...
    detail:
      '양식·산출물 등 나눠 줄 파일을 여러 개 올려 둡니다. 모듈을 누르면 파일 목록이 열려 바로 미리보기하거나 내려받을 수 있습니다. 여기 올린 파일은 이 프로젝트의 자료 관리에도 같은 파일로 나타납니다.',
    tab: 'file',
  },
}
