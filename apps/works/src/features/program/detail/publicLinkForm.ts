 ...
 *
 * **켜고 끄는 것은 사업 담당자다.** ADMIN이 정하는 것은 그 종류가 밖에 나갈 수 있는지의
 * 상한(`module_templates.allow_public_link`)이며, 담당자는 ADMIN이 열어 둔 템플릿 안에서
 * 자기 사업의 이 건을 지금 열지 말지를 고른다 — 정책과 운영은 다른 층이다.
 */
