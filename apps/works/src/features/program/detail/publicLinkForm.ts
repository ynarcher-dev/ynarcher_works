 ...
 *
 * 모듈 저장(set_program_module)과 **별개 원장**이라 저장 경로도 따로다. 다만 담당자에게는
 ...
 *
 * **켜고 끄는 것은 사업 담당자다.** ADMIN이 정하는 것은 그 종류가 바깥용인지의 성격
 * (`module_templates.visibility = 'PUBLIC_LINK'`)이며, 담당자는 그 종류에서 자기 사업의 이
 * 건을 지금 열지 말지를 고른다 — 정책과 운영은 다른 층이다.
 */
