 ...
 * - all: 전체 프로젝트. 위와 같은 목록을 담당 스코프 없이 넓힌 것이다.
 * 섹션 제목은 세 워크스페이스가 같은 말을 쓰므로 config가 아니라 사이드바 라벨 상수를 그대로 읽는다.
 *
...
export function ProgramWorkspacePage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <PageHeader title={mine ? PROGRAM_MINE_LABEL : PROGRAM_ALL_LABEL} />
