...
import { AiFillEvidence } from '@/features/ai/AiFillEvidence'
import { outcomeSummary, type AiFillOutcome } from '@/features/ai/aiTypes'
 ...
 */
export function AiFillOutcomeBody<K extends string>({
  outcome,
  cardLabel,
}: {
  ...
  return (
    <div className="space-y-2">
      <p>{outcomeSummary(outcome, cardLabel)}</p>
      ...
      <AiFillEvidence cards={outcome.filled} evidence={outcome.evidence} cardLabel={cardLabel} />
    </div>
  )
}
