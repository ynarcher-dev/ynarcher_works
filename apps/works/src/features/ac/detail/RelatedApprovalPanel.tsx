  ...
  return (
    <DetailPanelCard title="전자결재" count={approvals.length}>
      {approvals.length > 0 ? (
          ...
          <ul className="space-y-2.5">
            {pageItems.map((a) => (
              ...
              >
                ...
                <span className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-0.5 border-t border-gray-200 pt-2 text-caption text-gray-500">
        ...
        <p className="rounded-radius-md border border-gray-300 bg-white px-4 py-6 text-center text-body text-gray-400">
          연결된 전자결재가 없습니다.
        </p>
      )}
    </DetailPanelCard>
