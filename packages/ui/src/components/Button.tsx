...
const variantClass: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border border-transparent bg-gray-100 text-gray-800 hover:border-gray-300 hover:bg-white active:bg-gray-50',
  outline:
    'border border-gray-300 bg-white text-gray-800 hover:border-gray-400 hover:bg-gray-25 active:bg-gray-50',
