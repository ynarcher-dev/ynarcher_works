...
insert into _expected_auth values
    ...
    ('approval_budget_revisions', 'SELECT'),
    ...
    ('file_collection_assignments', 'SELECT'),
    ('file_collection_comments', 'SELECT'),
    ('file_collection_files', 'SELECT'),
    ('file_collection_nodes', 'SELECT'),
    ('file_collection_responses', 'SELECT'),
    ('file_collections', 'SELECT'),
...
insert into _expected_svc values
    ...
    ('export_jobs', ''),
    ('field_tags', ''),
    ('file_collection_assignments', ''),
    ('file_collection_comments', ''),
    ('file_collection_files', ''),
    ('file_collection_nodes', ''),
