...
- 숫자는 아라비아 숫자 + 단위. 문자열 항목 안의 숫자는 세 자리마다 쉼표를 넣습니다(예: 1,000명 · 12,345원).
- JSON 숫자 필드는 쉼표 없는 숫자로 씁니다. 금액 숫자 필드는 원 단위 정수(1억 = 100000000, 1백만 = 1000000)이며 통화 기호를 넣지 않습니다.
...
/**
 * §6.3 봉투 — notes는 저장되지 않고 검토에만 쓰인다.
 *
...
- notes는 카드마다 최대 ${LIMITS.notes}줄, 한 줄 80자 이내입니다.
